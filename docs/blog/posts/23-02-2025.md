...
echo "<p>You searched: $search_query</p>";
?>
```
...
app.get('/search', function(req, res){
  ...
  res.send('You searched: ' + searchTerm);
});
  ...
  <body>
    ...
    <script> 
      ...
      if(nombre == null){
        ...
        // Display the results in a non sanitized manner
  ...
  <body>
    ...
    <script> 
      ...
      if(nombre == null){
        ...
        document.getElementById('saludo').textContent = "Hola " + nombre + ", ¿Qué tal?";
      }
    </script>
  </body>
</html>
