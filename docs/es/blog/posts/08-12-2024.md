...
Con la clave extraída del archivo .env, podemos firmar tokens JWT válidos. Usamos una herramienta como <a href="https://jwt.io/" target="_blank">JWT.io</a> para generar el token con el rol de administrador:
