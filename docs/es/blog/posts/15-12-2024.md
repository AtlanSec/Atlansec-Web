...
summary: "Una guía detallada para instalar Android Studio, configurar certificados y usar Burp Suite, Frida y Objection en Linux/Debian."
date: 2024-12-15
tag:
    - Cybersecurity
    - Pentesting
...
1. Descarga el archivo ZIP de Android Studio desde la <a href="https://developer.android.com/studio" target="_blank">web oficial Android Studio</a>.
...
1. Descarga el binario `frida-server` desde la <a href="https://github.com/frida/frida/releases" target="_blank">web oficial de Frida</a>
