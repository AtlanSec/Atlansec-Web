...
1. Descarga el archivo ZIP de Android Studio desde la [web oficial Android Studio](https://developer.android.com/studio).
...
1. Descarga el binario `frida-server` desde la [web oficial de Frida](https://github.com/frida/frida/releases)
