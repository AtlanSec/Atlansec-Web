...
Como podemos ver, la página web está haciendo uso de la función `document.write()`, la cual inserta un parámetro `nombre` sin previa validación ni sanitización. Por tanto, le podemos pasar cualquier nombre como parámetro.
