...
// Haz la intro mas del estilo de la de los XSS, esta sobre to el principio no ha quedado mu fina
...
// Como uso un SSRF en una empresa para escanear la intranet de otra? 
...
### **SSRF Estándar**
// El uri schema de file no esta siempre habilitado , puedes usarlo como ejemplo de impacto pero no es el único, el escenario mas común es el de acceder a recursos para los que no estas autorizado, por otro lado /etc/passwd no es especialmente sensible, se usa en las PoCs por que existe siempre, mejor dejarlo en leer archivos internos en el servidor.
...
// Agregame aqui un ejemplo de la meta-data de amazon o de lectura de ficheros, o mejor los dos
...
// Detalla un poco con que fin hacemos esto como en las otras
