...
En concreto abusaremos de una funcionalidad concreta de este binario que permite la carga de claves publicas desde una libreria de lectura de tarjetas, esta opción es el parámetro -D, su uso es el siguiente.
